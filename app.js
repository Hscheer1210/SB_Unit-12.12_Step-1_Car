/*
Part One
Create a class for a Vehicle. Each vehicle instance should have the following properties:
    1) make
    2) model
    3) year
Each vehicle instance should have:
    1) access to a method called honk, which returns the string “Beep.”
    2) a method called toString, which returns the string containing the make, model and year.
*/
...
Each motorcycle instance should have:
    1) a property called numWheels which has a value of 2. 
    2) a revEngine method which returns “VROOM!!!”
*/
...
/*
Part Four
Create a class for a Garage. It should have:
    1) a property called vehicles which will store an array of vehicles
    2) a property called capacity which is a number indicating how many vehicles will fit in the garage. 
